...
class JumpStartModelDeployLambdaStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, lambda_layer, sagemaker_endpoint_iam_role_arn, **kwargs) -> None:
    ...
    lambda_fn_env = {
      ...
      'SAGEMAKER_IAM_ROLE_ARN': sagemaker_endpoint_iam_role_arn
    }
