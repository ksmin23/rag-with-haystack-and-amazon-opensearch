...
class SageMakerEndpointIAMRoleStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
    ...
    cdk.CfnOutput(self, 'SageMakerEndpointIAMRoleName', value=sagemaker_endpoint_role.role_name,
      export_name=f'{self.stack_name}-RoleName')
    cdk.CfnOutput(self, 'SageMakerEndpointIAMRoleArn', value=self.sagemaker_endpoint_role_arn,
