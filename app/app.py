...
import opensearch_chat_llama2_7b as llama2_7b
...
if 'llm_chain' not in st.session_state:
    st.session_state['llm_app'] = llama2_7b
    st.session_state['llm_chain'] = llama2_7b.build_chain()
...
def handle_input():
    ...
    if 'source_documents' in result:
        for d in result['source_documents']:
            if not (d['source'] in document_list):
                document_list.append((d['source']))
